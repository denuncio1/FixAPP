          ...
          <Card className="max-w-2xl mx-auto text-center">
            <CardHeader>
              <CardTitle className="flex items-center justify-center gap-2">
                <Bot className="h-6 w-6" /> Funcionalidade em Desenvolvimento
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Esta seção integrará um assistente virtual que pode interagir com usuários para coletar informações sobre problemas, realizar uma triagem inicial e sugerir soluções ou criar ordens de serviço automaticamente.
              </p>
